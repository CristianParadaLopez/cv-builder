...
import { FileText, Trash2, Download, Plus, LogOut, Sun, Moon, Home } from "lucide-react";
import { useAuth } from "../context/AuthContext";
import { getUserCVs, deleteCV } from "./services/cvStorage.ts";
import type { SavedCV } from "./services/cvStorage.ts";
...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--bg)", color: "var(--text)" }}>
            ...
            {/* NAVBAR */}
      <nav className="sticky top-0 z-50 border-b px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between gap-3"
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          ...
          <div className="hidden sm:block">
            ...
            <p className="text-[10px] mt-0.5" style={{ color: "var(--text-muted)" }}>Mis CVs</p>
          </div>
        </div>
